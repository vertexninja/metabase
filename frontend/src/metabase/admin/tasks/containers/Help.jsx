...
export default class Help extends Component {
  ...
  render() {
    ...
    const compactDetailString = JSON.stringify(details);
    return (
      <HelpRoot>
            ...
            <HelpLink
              ...
              link={
                MetabaseSettings.isPaidPlan()
                  ? `https://www.metabase.com/help-premium?utm_source=in-product&utm_medium=troubleshooting&utm_campaign=help&instance_version=${tag}&diag=${compactDetailString}`
