...
export default function ProfileLink({ user, handleCloseNavbar }) {
  ...
  const generateOptionsForUser = () => {
    ...
    const compactBugReportDetails = JSON.stringify(bugReportDetails);
      ...
      },
      {
        ...
        link:
          isAdmin && MetabaseSettings.isPaidPlan()
            ? `https://www.metabase.com/help-premium?utm_source=in-product&utm_medium=menu&utm_campaign=help&instance_version=${tag}&diag=${compactBugReportDetails}`
